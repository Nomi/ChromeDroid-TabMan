...
{
    internal class DiscoveredSocketOnlyDevToolsConnector : IChromiumDevToolsConnector
    {
        ...
        public DiscoveredSocketOnlyDevToolsConnector(string adbPath, string forwardParameter_Remote)
        {
            AdbPath = adbPath;
